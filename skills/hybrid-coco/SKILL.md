...
**Supported languages:** Python, JavaScript/TypeScript, Rust, Go, Java, C, C++, C#, Kotlin.
...
The file may not be in a supported language. hybrid-coco indexes Python, JavaScript/TypeScript, Rust, Go, Java, C, C++, C#, and Kotlin. For other languages, fall back to Grep.
