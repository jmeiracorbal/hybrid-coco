...
The file may not be in a supported language. hybrid-coco indexes Python, JavaScript/TypeScript, Rust, Go, Java, C, C++, and C#. For other languages, fall back to Grep.
